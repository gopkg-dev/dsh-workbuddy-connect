...
const WORKBUDDY_CONNECT_PACKAGE = "@gopkg-dev/dsh-workbuddy-connect";
...
async function readHostHeartbeat() {
	...
	try {
		...
		if (parsed.version === HEARTBEAT_FORMAT_VERSION && (parsed.package === "@gopkg-dev/dsh-workbuddy-connect" || parsed.package === "dsh-workbuddy-connect" || parsed.package === "dsh-workbuddy-connect-gopkg") && typeof parsed.registeredAt === "number" && typeof parsed.pid === "number") return {
			version: HEARTBEAT_FORMAT_VERSION,
...
//#endregion
export { normalizeCredits as A, installedAppVersion as B, defaultDesktopAuthPath as C, WorkBuddyUpstreamClient as D, workbuddyOwnAuthPath as E, PROBE_EFFORT_CANDIDATES as F, resolveAppVersion as H, probeModel as I, randomSentinel as L, prepareChatBody as M, prepareInternationalChatBody as N, classifyUpstreamError as O, regionOf as P, WORKBUDDY_APP_VERSION_FILENAME as R, defaultDesktopAuthCandidates as S, parseWorkBuddyAuth as T, validAppVersion as U, readBundleVersion as V, FALLBACK_WORKBUDDY_MODELS as _, WORKBUDDY_HOST_HEARTBEAT_FILENAME as a, WORKBUDDY_AUTH_FILE_ENV as b, processStartTimeMs as c, writeHostHeartbeat as d, WORKBUDDY_CONNECT_PACKAGE as f, FALLBACK_WORKBUDDY_AI_MODELS as g, WORKBUDDY_STATUS_PATH as h, variantFor as i, parseModelCatalog as j, modelWithCurrentPromotion as k, readHostHeartbeat as l, WORKBUDDY_PROBE_PATH as m, CN_VARIANT as n, clearHostHeartbeat as o, WORKBUDDY_CONNECT_VERSION as p, WORKBUDDY_VARIANTS as r, isHeartbeatProcessAlive as s, AI_VARIANT as t, workbuddyHostHeartbeatPath as u, WorkBuddyCatalog as v, desktopAuthCandidatesFor as w, WorkBuddyCredentialStore as x, WORKBUDDY_AUTH_FILENAME as y, appUserAgent as z };
