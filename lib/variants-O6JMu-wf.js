...
const WORKBUDDY_CONNECT_PACKAGE = "dsh-workbuddy-connect-gopkg";
...
async function readHostHeartbeat() {
	...
	try {
		...
		if (parsed.version === HEARTBEAT_FORMAT_VERSION && (parsed.package === "dsh-workbuddy-connect-gopkg" || parsed.package === "dsh-workbuddy-connect") && typeof parsed.registeredAt === "number" && typeof parsed.pid === "number") return {
			version: HEARTBEAT_FORMAT_VERSION,
